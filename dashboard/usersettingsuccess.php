...
<html lang="en">
<head>
    <title>User setting updated</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
        <div class="alert alert-success" style="margin-top: 80px;" role="alert">
        <h4 class="alert-heading" style="padding-bottom: 10px;">User settings updated!</h4>
            <ul>
