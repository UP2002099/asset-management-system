...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/inventory_management_system/css/header.css">
                    ...
                    <div class="d-flex justify-content-between">                    
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item dropdropdown">
                                    <a class="" href=""></a>
                                </li>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Inventory Augmenter</a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="http://localhost/inventory_management_system/inventory_augmenter/invedithard.php">Augment Hardware</a>
                                    <a class="dropdown-item" href="http://localhost/inventory_management_system/inventory_augmenter/inveditsoft.php">Augment Software</a>
                                </div>
                            </li>
                        </ul>
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="http://localhost/inventory_management_system/dashboard/usersettings.php">User Settings</a>
