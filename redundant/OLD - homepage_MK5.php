...
<head>
    ...
    <script src="jscript\header_navbar.js"></script>
</head>
<body>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdown1">
                                        ...
                                        <li class="dropdown-item dropdown show">
                                            ...
                                            <ul class="dropdown-menu show" aria-labelledby="dropdown1-1" style="top: 5px; left: 157.297px;">
                                                ...
                                                <li class="dropdown-item dropdown show">
                                                    ...
                                                    <ul class="dropdown-menu show" aria-labelledby="dropdown1-1-1" style="top: 5px; left: 169.391px;">
