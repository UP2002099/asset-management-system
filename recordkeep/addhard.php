            ...
            <form action="http://localhost/inventory_management_system/recordkeep/storehard.php" method="post">
                ...
                <div id="pcform" style="display:none">
                    ...
                    <div class="row row-form">
                        ...
                        <div class="col">
                            <label for="colour">PC Colour</label>
                    ...
                    <div class="row row-form">
                        <div class="col-2">
                            ...
                            <select class="form-control" name="cpu_make" onchange="showcpu(this.value)" required>
                                <option selected value="">CPU's brand</option>
                            ...
                            <input class="form-control other-style" type="text" name="cpu_model" placeholder="i7-9700K" required>
                        </div>
                        <div class="col-2">
                            <label for="gpu_make">GPU Details</label>
                            <br>
                            <select class="form-control" name="gpu_make" onchange="showgpu(this.value)" required>
                                <option selected value="">GPU's brand</option>
                            ...
                            placeholder="Max. 8 Characters" maxlength = "8">
                            <input class="form-control other-style" type="text" name="gpu_model" placeholder="RTX 2060" required>
                        </div>
                        <div class="col-4">
                            ...
                            <div class="input-group other-style">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-prepend">
                                        <input class="form-control" name="ram_speed" placeholder="Speed - MHz" required oninput="this.value=this.value.slice(0,this.maxLength)" 
                        ...
                        <div class="col-4">
                            <label for="storage_type">Drive Details</label>
                            <br>
                            <div class="input-group" id="primarydrive">
                                <input class="form-control" name="storage_cap1" placeholder="Drive 1 Capacity" required oninput="this.value=this.value.slice(0,this.maxLength)" 
                                type = "number" maxlength = "4" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                <div class="input-group-append">
                                    <select class="form-control" name="storage_unit1" required>
                                        <option selected value="">Unit</option>
                                        <option value="GB">GB</option>
                                ...
                                <div class="input-group-append">
                                    <select class="form-control" name="storage_type1" required>
                            ...
                            <div class="input-group other-style" id="secondarydrive">
                                <input class="form-control" name="storage_cap2" placeholder="Drive 2 Capacity" required oninput="this.value=this.value.slice(0,this.maxLength)" 
                                type = "number" maxlength = "4" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                <div class="input-group-append">
                                    <select class="form-control" name="storage_unit2" required>
                                        <option selected value="">Unit</option>
                                        <option value="GB">GB</option>
                                        <option value="TB">TB</option>
                                    </select>
                                ...
                                <div class="input-group-append">
                                    <select class="form-control" name="storage_type2" required>
                                        <option selected value="">Type</option>
                                        <option value="HDD">HDD</option>
                                        <option value="SSD">SSD</option>
                                    </select>
                ...
                <div id="miscform" style="display:none">
                    ...
                    <div class="row row-form">
                        ...
                        <div class="col">
                            ...
                            <input class="other-style" name="newmisctype" id="misctypeother" style='display:none;' placeholder="[Max. 16 Characters]"
                            oninput="this.value=this.value.slice(0,this.maxLength)" type = "text" maxlength = "16">
                        </div>
                    </div>
