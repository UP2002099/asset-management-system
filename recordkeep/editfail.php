...
<body>
    ...
    <div class="container">
        ...
        <h4 class="alert-heading" style="padding-bottom: 10px;">New data was not added, please check mysql error prompt below:</h4>
        <h5 class="alert-heading"><?php echo $_SESSION['updatefail']; ?></h5>
            <ul>
