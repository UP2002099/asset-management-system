...
require "../index/connection.php";
    ...
    $pc = "SELECT db_id, status, brand, name, model, warranty, cpu_make, 
        ...
        ram_speed, timestamp, userholding FROM pc";
...
// ====================================================================================
    ...
    $laptop = "SELECT db_id, status, brand, name, screensize, screenres, 
        ...
        timestamp, userholding FROM laptop";
...
// ====================================================================================
    ...
    $genpurpose = "SELECT db_id, status, brand, name, 
        licenseduration, licensenum, timestamp, userholding FROM genpurpose";
...
// ====================================================================================
    ...
    $opersystem = "SELECT db_id, status, brand, name, 
        licenseduration, licensenum, timestamp, userholding FROM opersystem";
...
// ====================================================================================
    ...
    $utility = "SELECT db_id, status, brand, name, 
        licenseduration, licensenum, timestamp, userholding FROM utility";
...
// ====================================================================================
    ...
    $miscsoft = "SELECT db_id, status, brand, name, 
        licenseduration, licensenum, timestamp, userholding FROM miscsoft";
