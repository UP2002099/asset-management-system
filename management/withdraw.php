...
<body>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center undernav-h1">
        <h1 class="h2 pl-3">Inventory Control - Withdraw Inventory</h1>
    </div>
        ...
        <div class="col">
            ...
            <div class="row row-form">
                <div class="col-10">
                    ...
                    <br>
                    <small style="color:darkgray"><i>Please be aware: you can only withdraw one item at a time</i></small>
                </div>
                <div class="col-2">
        ...
        <div class="col-12 my-auto">
            <div class="row row-form" id="listpc" style="display: none;">
                <div class="px-3">
                    ...
                    <small style="color:darkgray"><i>To start inventory withdrawal, click on a desired row to withdraw the chosen item</i></small>
                    ...
                    <div class="alert alert-success" role="alert" id="withdrawpc" style="display: none;">
                        <p style="margin-bottom: 0px" id="pcid"></p>
                        <p style="margin-bottom: 0px" id="pcname"></p>
                        <p style="margin-bottom: 0px" id="pcmodel"></p>
                        <button type="submit" class="btn btn-success " onclick="pcwithdraw();">Withdraw</button>
                    </div>
                    <div class="alert alert-danger" role="alert" id="xpc" style="display: none;">
                        <p style="margin-bottom: 0px">ALERT! STATUS OF ITEM PROHIBITS WITHDRAWAL!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row row-form" id="listlaptop" style="display: none;">
                <div class="px-3">
                    ...
                    <div class="alert alert-success" role="alert" id="withdrawlaptop" style="display: none;">
                        ...
                        <button type="submit" class="btn btn-success " onclick="laptopwithdraw();">Withdraw</button>
                    </div>
            ...
            <div class="row row-form" id="listmischard" style="display: none;">
                <div class="px-3">
                    ...
                    <div class="alert alert-success" role="alert" id="withdrawmischard" style="display: none;">
                        ...
                        <button type="submit" class="btn btn-success " onclick="mischardwithdraw();">Withdraw</button>
                    </div>
            ...
            <div class="row row-form" id="listgenpurpose" style="display: none;">
                <div class="px-3">
                    ...
                    <div class="alert alert-success" role="alert" id="withdrawgenpurpose" style="display: none;">
                        ...
                        <button type="submit" class="btn btn-success " onclick="genpurposewithdraw();">Withdraw</button>
                    </div>
            ...
            <div class="row row-form" id="listopersystem" style="display: none;">
                <div class="px-3">
                    ...
                    <div class="alert alert-success" role="alert" id="withdrawopersystem" style="display: none;">
                        ...
                        <button type="submit" class="btn btn-success " onclick="opersystemwithdraw();">Withdraw</button>
                    </div>
            ...
            <div class="row row-form" id="listutility" style="display: none;">
                <div class="px-3">
                    ...
                    <div class="alert alert-success" role="alert" id="withdrawutility" style="display: none;">
                        ...
                        <button type="submit" class="btn btn-success " onclick="utilitywithdraw();">Withdraw</button>
                    </div>
            ...
            <div class="row row-form" id="listmiscsoft" style="display: none;">
                <div class="px-3">
                    ...
                    <div class="alert alert-success" role="alert" id="withdrawmiscsoft" style="display: none;">
                        ...
                        <button type="submit" class="btn btn-success" onclick="miscsoftwithdraw();">Withdraw</button>
                    </div>
                    <div class="alert alert-danger" role="alert" id="xmiscsoft" style="display: none;">
                        <p style="margin-bottom: 0px">ALERT! STATUS OF ITEM PROHIBITS WITHDRAWAL!</p>
                        <button type="submit" class="btn btn-danger" disabled>Withdraw</button>
                    </div>
                </div>
            </div>
    ...
    <script src="../scripts/invcontrolwithdraw.js"></script>
